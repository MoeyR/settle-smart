...
function PostDetails() {
  ...
  const showUpdatedComments = (newCommentAdded) => {
    setCommentAdded(newCommentAdded);
  };
    ...
    <section className="post-details">
      ...
      <section className="title-content-wrap">
        ...
        <p className="post-details__location" onClick={handleShowMapClick}>
          <img
            className="post-details__location-icon"
            src={locationIcon}
            alt="location-icon"
          />
      ...
      {showMap && (
        <GoogleMap
          latitude={postDetails.post_latitude}
          longitude={postDetails.post_longitude}
        />
      )}
      {/* Comments Section */}
      <section className="comments-section">
        ...
        <CommentList
          comments={comments}
          showCommentsAfterDelete={showCommentsAfterDelete}
        />
      </section>
    </section>
  );
